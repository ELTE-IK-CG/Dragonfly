...
GLuint eltecg::ogl::helper::getInternalFormat(
		int num_of_channels = 3,
		int bytes_per_channel = 8)
{
...
GLuint eltecg::ogl::helper::getBaseFormat(GLuint internalFormat)
{
	...
	case GL_STENCIL_INDEX16:
		return GL_STENCIL_COMPONENT: //??  Missing from website.
		break;
	...
	case GL_RGB12:				case RGB16:			//Missing??
...
GLuint eltecg::ogl::helper::getBaseType(GLuint internalFormat)
{
// Trivial cases
	...
	case GL_RGB8I:				case GL_RGBA8I:
		return GL_BYTE;
		break;
	case GL_R16:				case GL_RG16:					case GL_RGB16: // Missing???
