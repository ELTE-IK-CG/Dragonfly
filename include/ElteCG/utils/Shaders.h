...
using ShaderEditorVF = Shaders<ShaderEditor<SFile>, ShaderEditor<SFile>>;
using ShaderEditorVGF = Shaders<ShaderEditor<SFile>, ShaderEditor<SFile>, ShaderEditor<SFile>>;
using ShaderEditorVTF = Shaders<ShaderEditor<SFile>, ShaderEditor<SFile>, NoShader, ShaderEditor<SFile>, ShaderEditor<SFile>>;
using ShaderEditorVGTF = Shaders<ShaderEditor<SFile>, ShaderEditor<SFile>, ShaderEditor<SFile>, ShaderEditor<SFile>, ShaderEditor<SFile>>;
using ShaderEditorCompute = Shaders<ShaderEditor<SFile>>;
